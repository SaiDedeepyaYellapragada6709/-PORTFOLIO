...
<head>
    ...
    <title>Portfolio - Computer Science Engineering</title>
...
<body>
    ...
    <nav class="navbar">
        <div class="nav-container">
            <div class="logo">
                <h1>Sai Dedeepya Yellapragada</h1>
            </div>
            <ul class="nav-menu">
    ...
    <section class="hero">
        <div class="hero-content">
            ...
            <p>Building innovative solutions through code and technology</p>
        ...
        <div class="container">
            ...
            <div class="projects-grid">
                <div class="project-card">
                    ...
                    <p>Description of your upcoming project. Include technologies used and the problem it solves.</p>
    ...
    <footer class="footer">
        <div class="container">
            <p>&copy; 2026 Sai Dedeepya Yellapragada. All rights reserved.</p>
        </div>
    </footer>
